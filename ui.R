...
fluidPage(
  ...
  mainPanel(
    ...
    tabPanel("Help", icon=icon("question-circle"),
             ...
             a("StayFree mobile app", href="https://play.google.com/store/apps/details?id=com.burockgames.timeclocker"), ". Try out the sample data,
               or follow the steps below to visualize your own phone usage:", target="_blank"),
             tags$ol(
               tags$li("Download ",
               ...
               tags$li('Use the data from the StayFree app to Export to an Excel File.'),
               tags$li('Browse to find the exported file(s) or drag them into the
    \"StayFree Export Usage File\" section on the sidebar of the ScreenTime Tracker app.')),
